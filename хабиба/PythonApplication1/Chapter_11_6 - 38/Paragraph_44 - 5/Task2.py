...
'''
    ...
    Из камней весом pi(i=1,...,N) набрать кучу весом ровно W или, если это невозможно,
    максимально близкую к W (но меньшую, чем W). Все веса камней и значение W – целые числа
'''
